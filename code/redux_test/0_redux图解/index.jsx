...
class Index extends Component {
    ...
    // 服务员把信息精简后告诉老板(Store)。老板让后厨(reducers)做饭，后厨做好，交给老板，顾客自取，开吃。
    ...
    // data是你的数据，可以是任何数据类型，且是可选的。比如初始化的时候，type是undefined（实际是@@init@@，表示初始化），
    //不进行任何操作我当然也可以不需要什么数据，所以可选(好像你不传，reducer默认初始化的值是0)。
