...
(function (global, factory) {
  ...
  // Filter certain DOM attributes (e.g. src_teacher, href) if their values are empty strings.
  ...
  // Please consider also adding to 'react-devtools-shared/src_teacher/backend/ReactSymbols'
  ...
  function isSameOriginFrame(iframe) {
    try {
      ...
      // to throw, e.g. if it has a cross-origin src_teacher attribute.
