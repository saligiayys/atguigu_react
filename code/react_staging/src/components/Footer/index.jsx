...
export default class Footer extends Component {
	...
	handleCheckAll = (event)=>{
		...
		//获取这个全选全不选按钮的checked值（true/false）传回给App。打勾就是true，不打勾false
	}
	...
	render() {
		...
		//pre是这个回调上一次的返回值，第一次调用时，pre是reduce的初始值，这里是0。
		...
		return (
			<div className="todo-footer">    
				<label>
					...
					但在react里，使用checked必须搭配onChange，否则就写死了。之前在Item组件里已经说过*/}
